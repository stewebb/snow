...
\usepackage[utf8]{inputenc} % allow the utf-8 input
...
The inclination value \( f_{inc} \in [0, 1] \) depends on the angle between the surface normal and the horizon normal. \( f_{inc}=1 \) means 
...
The snow factor is the user-defined function \( f_{u} \) in Section 3.1, making a potentially negative effect on the original snow. To 
simplify the simulation, the factor is based solely on the environmental temperature. If the temperature \( t \leq 0^\circ\mathrm{C}\), the 
...
while that of the sunlight varies by time, ranging from 0 to 1. Assume the sunlight intensity is 0 at night. It starts 
...
is the mathematical formula of the light intensity \( I \in (0, 1]\), which is a modified bell-shape curve.
\[
...
To simulate those colors, interpolation is needed to make the transition process smoother. 
\[
  C_{b}=
  \left\{
    \begin{array}{ll}
...
Figure 2 is the rendering effect with full snow (a), half snow (b), and no snow (c) respectively. The dynamic environment simulation is 
...
\begin{figure}[h]
  \centering
  \subfloat[Time = 12:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/T0000L60N.png}
    \label{fig:T0000L60N}
  }
  \subfloat[Time = 08:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/T0800L60N.png}
    \label{fig:T0800L60N}
  }
  \subfloat[Time = 11:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/T1100L60N.png}
    \label{fig:T1100L60N}
  }
  
  \subfloat[Time = 02:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/T1400L60N.png}
    \label{fig:T1400L60N}
  }
  \subfloat[Time = 05:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/T1700L60N.png}
    \label{fig:T1700L60N}
  }
  \subfloat[Time = 07:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/T1900L60N.png}
    \label{fig:T1900L60N}
  }
...
a dynamic environment system to control the snow amount and color-in-view by adjusting the temperature and simulating the daylight 
conditions. There is also an experiment on irregular conditions (summer in high-latitude locations) with some interesting findings. 
% /6. Conclusion
...
% Appendix
\section*{Appendix}
Figure 7 is a gallery of rendering results in different times, different object surfaces and different textures.
\begin{figure}[h]
  \centering
  \subfloat[10:00 AM, Front, Texture 1]{
    \includegraphics[width=0.33\textwidth]{images/F1000L35ST1.png}
    \label{fig:F1000L35ST1}
  }
  \subfloat[10:00 AM, Front, Texture 2]{
    \includegraphics[width=0.33\textwidth]{images/F1000L35ST2.png}
    \label{fig:F1000L35ST2}
  }
  \subfloat[10:00 AM, Front, Texture 3]{
    \includegraphics[width=0.33\textwidth]{images/F1000L35ST3.png}
    \label{fig:F1000L35ST3}
  }
  
  \subfloat[10:00 AM, Rear, Texture 1]{
    \includegraphics[width=0.33\textwidth]{images/R1000L35ST1.png}
    \label{fig:R1000L35ST1}
  }
  \subfloat[10:00 AM, Rear, Texture 2]{
    \includegraphics[width=0.33\textwidth]{images/R1000L35ST2.png}
    \label{fig:R1000L35ST2}
  }
  \subfloat[10:00 AM, Rear, Texture 3]{
    \includegraphics[width=0.33\textwidth]{images/R1000L35ST3.png}
    \label{fig:R1000L35ST3}
  }

  \subfloat[10:00 PM, Front, Texture 1]{
    \includegraphics[width=0.33\textwidth]{images/F2200L35ST1.png}
    \label{fig:F2200L35ST1}
  }
  \subfloat[10:00 PM, Front, Texture 2]{
    \includegraphics[width=0.33\textwidth]{images/F2200L35ST2.png}
    \label{fig:F2200L35ST2}
  }
  \subfloat[10:00 PM, Front, Texture 3]{
    \includegraphics[width=0.33\textwidth]{images/F2200L35ST3.png}
    \label{fig:F2200L35ST3}
  }

  \subfloat[10:00 PM, Rear, Texture 1]{
    \includegraphics[width=0.33\textwidth]{images/R2200L35ST1.png}
    \label{fig:R2200L35ST1}
  }
  \subfloat[10:00 PM, Rear, Texture 2]{
    \includegraphics[width=0.33\textwidth]{images/R2200L35ST2.png}
    \label{fig:R2200L35ST2}
  }
  \subfloat[10:00 PM, Rear, Texture 3]{
    \includegraphics[width=0.33\textwidth]{images/R2200L35ST3.png}
    \label{fig:R2200L35ST3}
  }
  \caption{Rendering output gallery}
  \label{fig:Gallery}
\end{figure}
% /Appendix
\end{document}