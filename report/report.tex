...
rendering as it determines the snow color in the eye view. 
...
It also implements a simple snow rendering and dynamic daylight system, as well as the connections between them.
% 1. Introduction
...
terrain can be calculated by using ray tracing [4]. The Solar Time, Sunrise and Sunset time can be calculated and predicted by a set 
of non-linear equations accurately [5].
% 2. Background
