...
Figure 2 is the inclination map, which also uses different colors to indicate the exposure value. 
...
\begin{figure}[h]
  ...
  \subfloat[Time = 12:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/AllT0000L35S.png}
    \label{fig:AllT0000L35S}
  }
  \subfloat[Time = 08:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/ALLT0800L35S.png}
    \label{fig:ALLT0800L35S}
  }
  \subfloat[Time = 11:00 AM]{
    \includegraphics[width=0.33\textwidth]{images/ALLT1100L35S.png}
    \label{fig:ALLT1100L35S}
  }

  \subfloat[Time = 02:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/ALLT1400L35S.png}
    \label{fig:ALLT1400L35S}
  }
  \subfloat[Time = 05:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/ALLT1700L35S.png}
    \label{fig:ALLT1700L35S}
  }
  \subfloat[Time = 07:00 PM]{
    \includegraphics[width=0.33\textwidth]{images/ALLT1900L35S.png}
...
% Result 2: Snow Effect with Dynamic Daylight Simulation (High Latitude)
