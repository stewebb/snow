...
temperature and maximum snow amount on a point, a bell-curve sunlight intensity formula, and an interpolation schema for sun color 
and sky color. Lastly, the paper demonstrates the results of the above approaches and algorithms, including the static pure snow 
effect and two dynamic snow effects based on location.
\end{abstract}
% /Abstract
